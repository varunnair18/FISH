...
from custom_trainer import MultiStageResetTrainer
...
def main():
    ...
    if training_args.mask_method == "bias":
        get_importance_mask = create_mask_bias
    elif training_args.mask_method == "random":
        get_importance_mask = create_mask_random
    elif training_args.mask_method == "deviation":
        get_importance_mask = create_mask_deviation
    else:
        sample_type, grad_type = training_args.mask_method.split("-")
        get_importance_mask = create_mask_gradient

    trainer = MultiStageResetTrainer(
        model=model,
        args=training_args,
        ...
        mask_method=training_args.mask_method,
    ...
    trainer.get_importance_mask = get_importance_mask
